...
MySQL - 10.4.14-MariaDB : Database - autism
*********************************************************************
*/
...
CREATE TABLE `data_latih` (
  `id_latih` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_latih`)
) ENGINE=InnoDB AUTO_INCREMENT=293 DEFAULT CHARSET=utf8;

/*Data for the table `data_latih` */

insert  into `data_latih`(`id_latih`,`A1_Score`,`A2_Score`,`A3_Score`,`A4_Score`,`A5_Score`,`A6_Score`,`A7_Score`,`A8_Score`,`A9_Score`,`A10_Score`,`age`,`gender`,`ethnicity`,`jundice`,`autism`,`contry_of_res`,`used_app_before`,`result`,`age_desc`,`relation`,`Class`) values 
...
CREATE TABLE `hasil_uji` (
  ...
  KEY `id_uji` (`id_uji`),
  CONSTRAINT `hasil_uji_ibfk_1` FOREIGN KEY (`id_uji`) REFERENCES `data_uji` (`id_uji`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

/*Data for the table `hasil_uji` */

insert  into `hasil_uji`(`id_hasil`,`id_uji`,`status_normal`,`status_autis`,`hasil_status`,`time`) values 
(1,3,0.00031778984698508,0.00000016964645200121,'Normal','2021-03-16 00:22:47'),
(2,4,0.012832634302388,0.000073685652687092,'Normal','2021-03-16 00:30:52'),
(3,5,0.0008820040036162,0.20014612018741,'ASD','2021-03-16 00:36:09'),
(4,6,0.00020824679920243,0.013984380648187,'ASD','2021-03-16 00:38:12'),
(5,7,0.000027477508291791,0.014185770982606,'ASD','2021-03-16 00:40:16');
