                            ...
                            <div class="row">
                                ...
                                <div class="col-xl col-lg-5">
                                    <div class="card shadow mb-4" style="height: 95%;">
                                        ...
                                        <div class="card-body">
                                            <h4 class="small font-weight-bold">Akurasi Total <span class="float-right akurasitotal">0%</span></h4>
                                            <div class="progress mb-4">
                                                <div class="progress-bar bg-danger bar1" role="progressbar" style="width: 0%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
