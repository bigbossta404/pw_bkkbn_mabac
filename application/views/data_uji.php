                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4 ml-auto ">
                            <div class="card h-100 w-100 boxbtn">
                                <a href="<?= base_url('hitung') ?>" class="card bg-primary font-weight-bold text-white shadow w-100 h-75 py-2 btnhitung btnatas">
                                    Mulai Hitung
                                </a>
                                <div class="row h-50">
                                    <div class="col btn-area">
                                        <a href="#" class="card bg-warning font-weight-bold text-white shadow  py-2 btnhitung" id="cektesting">
                                            Nilai Uji
                                        </a>
                                    </div>
                                </div>
